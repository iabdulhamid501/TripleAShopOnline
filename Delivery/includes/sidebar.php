<?php
// Delivery Sidebar - VELORIA Style
// Place this file in Delivery/includes/sidebar.php
// The session variable 'delivery_username' is set during login.
?>
<style>
    /* VELORIA Delivery Sidebar - Modern & Elegant */
    .veloria-sidebar {
        background: #2A2826;
        color: #E3DCD5;
        min-height: 100vh;
...
<div class="veloria-sidebar d-flex flex-column h-100">
    <div class="nav flex-column">
        <div class="sb-sidenav-menu-heading">Delivery Menu</div>
        ...
        <!-- Update Order Status -->
        <a class="nav-link" href="update-order-status.php">
        ...
        <!-- Chat with Agent -->
        <a class="nav-link" href="chat-agent.php">
            <i class="fas fa-user-tie"></i> Chat with Agent
        </a>
        
        <!-- Profile & Settings -->
        <div class="sb-sidenav-menu-heading">Account</div>
        <a class="nav-link" href="delivery-profile.php">
    ...
    <!-- Sidebar Footer (logged in delivery) -->
    <div class="sb-sidenav-footer mt-auto">
        <div class="small">Logged in as:</div>
        <?php echo htmlspecialchars($_SESSION['delivery_username'] ?? 'Delivery'); ?>
    </div>
</div>
