...
<head>
    ...
    <title>Cancelled Orders | Triple A ShopOnline</title>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="px-4 pt-3">
                <div class="d-flex justify-content-between align-items-center mt-2 mb-4">
                    <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Manage Cancelled Orders</h1>
                ...
                <div class="data-card">
                    <div class="card-header-custom">
                        <span><i class="fas fa-ban me-2"></i> Cancelled Order Details</span>
                    ...
                    <div class="table-responsive">
                        <table class="table-custom" id="ordersTable">
                            ...
                            <tbody id="tableBody">
                                <?php
                                // Prepare statement to fetch cancelled orders, grouped by order, with correct total amount
                                $sql = "SELECT 
                                            o.id AS order_id, 
                                            o.orderDate, 
                                            o.orderStatus, 
                                ...
                                <tr class="order-row">
                                    ...
                                    <td><span class="badge-cancelled"><?php echo htmlspecialchars($row['orderStatus']); ?></span></td>
                                    <td>
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="7" class="text-center">No cancelled orders found. --</a></td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
