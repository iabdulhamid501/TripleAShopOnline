...
<head>
    ...
    <title>In Transit Orders | Triple A ShopOnline</title>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="px-4 pt-3">
                <div class="d-flex justify-content-between align-items-center mt-2 mb-4">
                    <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Manage In Transit Orders</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-custom">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">In Transit Orders</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="data-card">
                    <div class="card-header-custom">
                        <span><i class="fas fa-shipping-fast me-2"></i> In Transit Order Details</span>
                    ...
                    <div class="table-responsive">
                        <table class="table-custom" id="ordersTable">
                            ...
                            <tbody id="tableBody">
                                <?php
                                // Prepare statement to fetch 'In Transit' orders with correct total amount (sum over all products)
                                $sql = "SELECT 
                                            o.id AS order_id, 
                                            o.orderDate, 
                                            o.orderStatus, 
                                ...
                                <tr class="order-row">
                                    ...
                                    <td><span class="badge-transit"><?php echo htmlspecialchars($row['orderStatus']); ?></span></td>
                                    <td>
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="7" class="text-center">No in transit orders found. --</a></td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
