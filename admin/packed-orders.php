...
<head>
    ...
    <title>Packed Orders | Triple A ShopOnline</title>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="px-4 pt-3">
                <div class="d-flex justify-content-between align-items-center mt-2 mb-4">
                    <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Manage Packed Orders</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-custom">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Packed Orders</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="data-card">
                    <div class="card-header-custom">
                        <span><i class="fas fa-boxes me-2"></i> Packed Order Details</span>
                    ...
                    <div class="table-responsive">
                        <table class="table-custom" id="ordersTable">
                            ...
                            <tbody id="tableBody">
                                <?php
                                // Prepare statement to fetch packed orders with correct total amount (sum over all products)
                                $sql = "SELECT 
                                            o.id AS order_id, 
                                            o.orderDate, 
                                            o.orderStatus, 
                                ...
                                <tr class="order-row">
                                    ...
                                    <td><span class="badge-packed"><?php echo htmlspecialchars($row['orderStatus']); ?></span></td>
                                    <td>
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="7" class="text-center">No packed orders found. --</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
