...
<head>
    ...
    <title>Dispatched Orders | Triple A ShopOnline</title>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="px-4 pt-3">
                <div class="d-flex justify-content-between align-items-center mt-2 mb-4">
                    <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Manage Dispatched Orders</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-custom">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Dispatched Orders</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="data-card">
                    <div class="card-header-custom">
                        <span><i class="fas fa-truck me-2"></i> Dispatched Order Details</span>
                    ...
                    <div class="table-responsive">
                        <table class="table-custom" id="ordersTable">
                            ...
                            <tbody id="tableBody">
                                <?php
                                // Prepare statement to fetch dispatched orders with correct total amount (sum over all products)
                                $sql = "SELECT 
                                            o.id AS order_id, 
                                            o.orderDate, 
                                            o.orderStatus, 
                                        ...
                                        WHERE o.orderStatus = 'Dispatched'
                                ...
                                <tr class="order-row">
                                    ...
                                    <td><span class="badge-dispatched"><?php echo htmlspecialchars($row['orderStatus']); ?></span></td>
                                    <td>
                                        <a href="order-details.php?oid=<?php echo $row['order_id']; ?>" class="btn-action" target="_blank" title="View Order Details">
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="7" class="text-center">No dispatched orders found. --</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
