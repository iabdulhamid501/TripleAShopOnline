...
// Fetch all open chat sessions for this agent
$query = "SELECT cs.id as session_id, cs.order_id, cs.product_size, cs.created_at as chat_started,
          ...
          WHERE cs.agent_id = ? AND cs.status = 'open'
...
<head>
    ...
    <title>Active Chats | Triple A ShopOnline</title>
    ...
    <div class="admin-content-wrapper">
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Active Chats</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-custom">
                        <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Active Chats</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table-custom">
                        ...
                        <?php 
                            ...
                            echo '<tr><td colspan="9" class="text-center">No active chat sessions.<?td?>';
                        }
                        ?>
                        </tbody>
                    </table>
