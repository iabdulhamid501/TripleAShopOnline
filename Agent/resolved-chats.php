...
// Fetch only closed chat sessions – include product_id for correct image path
...
<head>
    ...
    <title>Resolved Chats | Triple A ShopOnline</title>
    ...
    <style>
        ...
        .data-card { background: white; border-radius: 24px; border: 1px solid #EFE8E2; padding: 1.5rem; }
        ...
        .badge-resolved { background: #2E7D32; color: white; padding: 4px 12px; border-radius: 40px; font-size: 0.7rem; font-weight: 600; }
    ...
    <div class="admin-content-wrapper">
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2" style="font-family: 'Instrument Serif', serif;">Resolved Chats</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-custom">
                        <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Resolved Chats</li>
                    </ol>
                </nav>
            </div>
            <div class="data-card">
                <div class="table-responsive">
                    <table class="table-custom">
                        <thead>
                            <tr><th>#</th><th>Image</th><th>Order ID</th><th>Customer</th><th>Product</th><th>Size</th><th>Started</th><th>Resolved</th><th>Status</th></tr>
                        </thead>
                        <tbody>
                        ...
                        <?php endwhile; else: ?>
                            <tr><td colspan="9" class="text-center">No resolved chats yet.<?td?>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
