...
if(isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM agents WHERE username='$username' AND password='$password'");
...
<head>
    ...
    <title>Agent Login | Triple A ShopOnline</title>
...
<div class="login-container">
    <div class="login-card">
        <div class="login-header">
            <h2><i class="fas fa-user-tie"></i> Agent Portal</h2>
            <p>Triple A ShopOnline – Customer Support Access</p>
        </div>
